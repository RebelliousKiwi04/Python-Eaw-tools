...
class TextFile:
    def __init__(self, mod_dir, decompile_target='file'):
        self.mod_dir = mod_dir
        self.decompile_target = 'file'
        if decompile_target == 'dict':
            self.decompile_target = 'dict'
    def decompileDat(self):
        #Open The Dat File in binary mode
        f = open(self.mod_dir + '/Text/MasterTextFile_ENGLISH.dat', 'rb')
        datfile = f.read()
    ...
    def compileDat(self, source):
        ...
        if type(source) is dict:
            ...
            file = open('MasterTextFile_ENGLISH.txt', 'r', encoding='utf-8')
